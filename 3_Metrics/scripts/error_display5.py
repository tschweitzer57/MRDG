...
# ============================================================
DATASET_FOLDER_1 = './datasets/LK_INIT'

# ============================================================
#  C-SLAM results folder paths — adapt these paths for each experiment
# ============================================================
RESULTS_FOLDER_1 = './input/LK_INIT_mbadmm10_2026_06_02_13_15'
RESULTS_FOLDER_2 = './input/LK_INIT_mbadmm200_2026_06_02_13_54'
RESULTS_FOLDER_3 = './input/LK_INIT_mesa_2026_06_02_11_37'

DATASET_FOLDERS = [DATASET_FOLDER_1]
RESULTS_FOLDERS = [RESULTS_FOLDER_2, RESULTS_FOLDER_3]
SOLVERS        = ['geodesic-pyxis', 'geodesic-mesa-2']
OUTPUT_FOLDER  = 'saved_output'

# Check detection_lk before detection (more specific)
SCENARIOS = ['lk_ideal', 'lk_noisygt', 'lk_realgood', 'lk_realworse']
ROBOTS    = [5, 55]
...
for solver, results in DataGroup.sorted_results.items():
    for result in results:
        scenario, _ = parse_dataset_name(result.dataset_name)
        if scenario:
            ...
            groups[scenario].append((label, result))
